...
class PointLight{
    ...
    PointLight(Vector3 n_position,QColor n_color):color(n_color),center(n_position),radius(0),distributor(NULL){}
    PointLight(Vector3 n_position, QColor n_color,Sampler* dist,double radiuss):
